<template>
  <v-hover v-slot="{ hover }">
    ...
    >
      <v-img :aspect-ratio="16 / 9" :src="contest.imgUrl">
        <v-expand-transition>
          <div v-if="hover" :class="hoverColorStr" style="height: 60%">
      ...
      <v-card-text style="position: relative">
        主办方：{{
          contest.sponsorTrueName ? contest.sponsorTrueName : contest.sponsor
        }}
      </v-card-text>
    </v-card>
  </v-hover>
